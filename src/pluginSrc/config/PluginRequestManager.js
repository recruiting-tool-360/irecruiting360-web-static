...
export const pluginAllUrls = {
  ...
  JOB51: {
    ...
    mainUrl: "https://ehire.51job.com/Revision/navigate/",
...
export const getPluginBaseConfig = () => {
  ...
  pluginEmptyRequestTemplate.parameters = [
    ...
    },
    {
      ...
      headers: [
        "https://ehirej.51job.com/jobvalueadded/exchange-rights/telescope_authority?",
        "https://ehirej.51job.com/login/dologin/getlastip?",
        "https://ehirej.51job.com/jobvalueadded/exchange-rights/telescope_authority?"
      ],
      requestFilterType: ["requestHeaders"],
