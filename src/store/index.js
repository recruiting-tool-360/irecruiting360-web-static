...
import AppStatus from "src/store/modules/AppStatus";
...
const store = createStore({
  ...
  actions: {},
  modules: {
    TestConfig,PluginConfig,ChatConfig,AiSerachConfig,ChannelConfig,UserConfig,chatList,AppStatus
  },
  plugins: [
